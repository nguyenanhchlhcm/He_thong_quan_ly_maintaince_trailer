  ...
  return (
    <div className="min-h-screen bg-slate-950 pb-24">
      ...
      <div className="sticky top-14 z-40 bg-slate-950/80 backdrop-blur-md border-b border-slate-800 px-4 py-3 flex items-center gap-3">
        ...
        <div>
          <h2 className="text-lg font-bold text-slate-100">Chỉnh Sửa Phiếu Bảo Trì (Admin)</h2>
          <p className="text-xs text-slate-500">Cập nhật thông tin chi tiết sửa chữa của phiếu</p>
        </div>
      </div>
